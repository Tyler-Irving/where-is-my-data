      ...
      <header className="h-14 bg-black border-b border-white/[0.06] px-4 md:px-6 flex items-center justify-between sticky top-0 z-50">
        ...
        <div className="flex items-center gap-1.5">
          ...
          <Button
            ...
            className="md:hidden rounded-xl bg-white/[0.05] hover:bg-white/[0.10] border border-white/[0.06] text-white/60 hover:text-white"
            aria-label="Search"
          >
          ...
          <Button
            ...
            className="rounded-xl bg-white/[0.05] hover:bg-white/[0.10] border border-white/[0.06] text-[#00D084] hover:text-white"
          ...
          <Button
            ...
            className="rounded-xl bg-white/[0.05] hover:bg-white/[0.10] border border-white/[0.06] text-white/35 hover:text-white"
            aria-label="About"
          ...
          <Button
            ...
            className="hidden md:flex rounded-xl bg-white/[0.05] hover:bg-white/[0.10] border border-white/[0.06] text-white/35 hover:text-white"
